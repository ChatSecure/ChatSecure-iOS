...
open class OTRGroupAvatarGenerator {
    ...
    open static func avatarImage(withUniqueIdentifier identifier: String) -> UIImage {
        ...
        let a = Int(generator.random() * 31) - 15
        let b = Int(generator.random() * 31) - 15
        let c = Int(generator.random() * 31) - 15
        let d = Int(generator.random() * 31) - 15
        ...
        if let ctx = UIGraphicsGetCurrentContext() {
            ...
            ctx.addLine(to: CGPoint(x: 0, y: 33 + a))
            ctx.addLine(to: CGPoint(x: 100, y: 33 + c))
            ...
            ctx.move(to: CGPoint(x: 0, y: 66 + b))
            ctx.addLine(to: CGPoint(x: 0, y: 100))
            ctx.addLine(to: CGPoint(x: 100, y: 100))
            ctx.addLine(to: CGPoint(x: 100, y: 66 + d))
            ctx.addLine(to: CGPoint(x: 0, y: 66 + b))
            ctx.drawPath(using: .fill)
        }
