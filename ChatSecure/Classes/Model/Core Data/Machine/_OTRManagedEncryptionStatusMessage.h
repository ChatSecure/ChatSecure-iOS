...
@interface OTRManagedEncryptionStatusMessageID : OTRManagedMessageAndStatusID {}
@end
...
@property (nonatomic, readonly, strong) OTRManagedEncryptionStatusMessageID* objectID;
