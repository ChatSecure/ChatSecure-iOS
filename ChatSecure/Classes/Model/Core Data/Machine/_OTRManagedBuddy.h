...
@property (nonatomic, readonly, strong) OTRManagedBuddyID* objectID;
...
@interface _OTRManagedBuddy (EncryptionStatusMessagesCoreDataGeneratedAccessors)
...
@interface _OTRManagedBuddy (GroupsCoreDataGeneratedAccessors)
...
@interface _OTRManagedBuddy (MessagesCoreDataGeneratedAccessors)
...
@interface _OTRManagedBuddy (MessagesandstatusesCoreDataGeneratedAccessors)
...
@interface _OTRManagedBuddy (StatusesCoreDataGeneratedAccessors)
