...
static CGFloat const kOTRMessageTextWidthMax = 180;
...
-(void)setMessage:(OTRManagedChatMessage *)newMessage
{
    ...
    if (self.showDate) {
        ...
        messageSentDateLabelHeight = kOTRMessageSentDateLabelHeight;
    } else {
...
+(CGSize)messageTextLabelSize:(NSString *)message
{
    ...
    return  [label sizeThatFits:CGSizeMake(kOTRMessageTextWidthMax, CGFLOAT_MAX)];
}
