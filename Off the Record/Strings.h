...
#define DELIVERED_STRING [OTRLanguageManager translatedString: @"Deliverd"]
...
#define DISCONNECTION_WARNING_TITLE_STRING [OTRLanguageManager translatedString: @"Signout Warning"]
