...
Now you'll need to build the dependencies. During this process we will automatically clone the sources off GitHub. You will need to have OpenSSH installed and have a [private key linked to your GitHub account](https://help.github.com/articles/adding-a-new-ssh-key-to-your-github-account/).
