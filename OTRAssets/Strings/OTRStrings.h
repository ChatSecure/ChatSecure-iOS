...
#define NO_DEVICES_BUDDY_ERROR_STRING [OTRLanguageManager translatedString: @"We could not find any trusted devices for this contact."]
#define Server_String [OTRLanguageManager translatedString: @"Server"]
...
#define Basic_Setup [OTRLanguageManager translatedString: @"Basic Setup"]
...
#define Could_Not_Decrypt_Database [OTRLanguageManager translatedString: @"Could not decrypt database. If the app is not working properly, you may need to delete and reinstall."]
#define Profile_String [OTRLanguageManager translatedString: @"Profile"]
#define Unrecognized_Invite_Format [OTRLanguageManager translatedString: @"Unrecognized Invite Format"]
...
#define Crash_Detected_Title [OTRLanguageManager translatedString: @"Crash Detected"]
#define RESEND_MESSAGE_TITLE [OTRLanguageManager translatedString: @"Resend Message"]
#define SEND_PLAINTEXT_STRING [OTRLanguageManager translatedString: @"Send plaintext message"]
...
#define RESEND_DESCRIPTION_STRING [OTRLanguageManager translatedString: @"Resending this message will use %@."]
...
#define Microphone_Disabled [OTRLanguageManager translatedString: @"Microphone Disabled"]
...
#define MY_QR_CODE [OTRLanguageManager translatedString: @"My QR Code"]
#define Server_String_Hint [OTRLanguageManager translatedString: @"Choose from our list of trusted servers, or use your own."]
...
#define Database_Error_String [OTRLanguageManager translatedString: @"Database Error"]
#define LOGIN_AUTOMATICALLY_STRING [OTRLanguageManager translatedString: @"Login Automatically"]
#define UNTRUSTED_DEVICE_STRING [OTRLanguageManager translatedString: @"Untrusted Device"]
...
#define Removed_By_Server [OTRLanguageManager translatedString: @"Removed By Server"]
#define OPEN_IN_FACEBOOK_STRING [OTRLanguageManager translatedString: @"Open in Facebook"]
#define Show_Advanced_Encryption_Settings [OTRLanguageManager translatedString: @"Show Advanced Encryption Settings"]
...
#define Advanced_Crypto_Warning [OTRLanguageManager translatedString: @"Don't change these unless you really know what you're doing. By default we will always select the best available encryption method."]
...
#define Crash_Detected_Message [OTRLanguageManager translatedString: @"The app crashed last time it was launched. Send a crash report?"]
...
#define Plaintext_Opportunistic_OTR [OTRLanguageManager translatedString: @"Plaintext (Opportunistic OTR)"]
...
#define SEND_ENCRYPTED_STRING [OTRLanguageManager translatedString: @"Send %@ encrypted message"]
#define OTRL_MSGEVENT_SETUP_ERROR_STRING [OTRLanguageManager translatedString: @"A private conversation could not be set up."]
#define UNKNOWN_ERROR_STRING [OTRLanguageManager translatedString: @"Unknown Error"]
...
#define Advanced_Encryption_Settings [OTRLanguageManager translatedString: @"Advanced Encryption Settings"]
...
#define Basic_Setup_Hint [OTRLanguageManager translatedString: @"Think of a unique nickname that you don't use anywhere else and doesn't contain personal information."]
...
#define VIEW_PROFILE_STRING [OTRLanguageManager translatedString: @"View Profile"]
...
#define Nickname_String [OTRLanguageManager translatedString: @"Nickname"]
#define UNTRUSTED_DEVICE_REVEIVED_STRING [OTRLanguageManager translatedString: @"This message was received from an untrusted device."]
...
#define UNENCRYPTED_STRING [OTRLanguageManager translatedString: @"plaintext"]
#define EXPIRATION_STRING [OTRLanguageManager translatedString: @"Background session will expire in one minute."]
#define Enable_Tor_String [OTRLanguageManager translatedString: @"Enable Tor"]
#define Show_Advanced_Options [OTRLanguageManager translatedString: @"Show Advanced Options"]
#define Me_String [OTRLanguageManager translatedString: @"Me"]
...
#define VIEW_PROFILE_DESCRIPTION_STRING [OTRLanguageManager translatedString: @"View profile to review contact's devices or change encryption settings."]
...
#define NO_DEVICES_ACCOUNT_ERROR_STRING [OTRLanguageManager translatedString: @"We could not find any trusted devices for this account."]
#define Microphone_Reenable_Please [OTRLanguageManager translatedString: @"To use this feature you must re-enable microphone permissions."]
...
#define Choose_Server_String [OTRLanguageManager translatedString: @"Choose Server"]
...
#define Generate_Secure_Password_Hint [OTRLanguageManager translatedString: @"We can automatically generate you a secure password. If you choose your own, make sure it's a unique password you don't use anywhere else."]
#define Best_Available [OTRLanguageManager translatedString: @"Best Available"]
...
#define Generate_Secure_Password [OTRLanguageManager translatedString: @"Generate Secure Password"]
...
#define Plaintext_Only [OTRLanguageManager translatedString: @"Plaintext Only"]
...
#define UNTRUSTED_DEVICE_SENT_STRING [OTRLanguageManager translatedString: @"This message was sent to an untrusted device."]
...
#define Enable_String [OTRLanguageManager translatedString: @"Enable"]
...
#define Customize_Username [OTRLanguageManager translatedString: @"Customize Username"]
