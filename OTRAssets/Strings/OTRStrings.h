...
#define NO_DEVICES_ERROR_STRING [OTRLanguageManager translatedString: @"We could not find any trusted devices for this contact."]
...
#define UNKNOWN_ERROR_STRING [OTRLanguageManager translatedString: @"Unkown Error."]
