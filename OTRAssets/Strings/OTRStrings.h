...
#define SEND_PLAINTEXT_STRING [OTRLanguageManager translatedString: @"Send unencrypted message"]
...
#define SEND_OMEMO_STRING [OTRLanguageManager translatedString: @"Send OMEMO encrypted message"]
...
#define SEND_OTR_STRING [OTRLanguageManager translatedString: @"Send OTR encrypted message"]
...
#define UNENCRYPTED_STRING [OTRLanguageManager translatedString: @"Unencrypted"]
#define EXPIRATION_STRING [OTRLanguageManager translatedString: @"Background session will expire in one minute."]
#define VIEW_DEVICES_STRING [OTRLanguageManager translatedString: @"View Devices"]
